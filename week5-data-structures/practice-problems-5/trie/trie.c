...
// 1. iterate on the word length
// 2. get the current letter of the word
// 3. if that letter doesn't exist in the trie then the word doesn't exist
// 4. move to the next letter
// 5. check if the current is_word or not and return it
bool check(char *word)
{
    int index;
    node *cursor = root;
